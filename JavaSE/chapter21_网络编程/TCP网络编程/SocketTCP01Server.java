...
public class SocketTCP01Server {
    public static void main(String[] args) throws IOException {
        ...
        //由InetAddress对象创建InetSocketAddress对象  要求9999端口没有被占用
        InetSocketAddress inetSocketAddress = new InetSocketAddress(localHost,9999);
        //创建Socket对象  //ServerSocket可以使用accept方法，返回多个Socket，这样可以多个计算机连接到同一个服务器上
        ServerSocket serverSocket = new ServerSocket();  //也可以这样ServerSocket serverSocket = new ServerSocket(9999);代表监听本机的9999端口
        //绑定Socket地址和端口
